...
class MatchingService {
     ...
     */
    static calculateMatchScore(mechanic, input) {
        ...
        const distanceKm = (0, distance_js_1.calculateDistanceKm)(input.customerLat, input.customerLng, mechLat, mechLng);
        const etaMinutes = (0, distance_js_1.calculateEtaMinutes)(distanceKm);
