...
export class BookingController {
  public static async createBooking(req: AuthRequest, res: Response) {
    try {
      ...
      if (!customerId) return res.status(400).json({ success: false, message: "Customer profile required." });
      ...
      SocketService.notifyMechanicsNewRequest(targetMechanicIds, {
        request: newRequest,
        booking: newRequest,
        bestMatch,
  ...
  public static async acceptBooking(req: AuthRequest, res: Response) {
    try {
      const mechanicId = req.user?.mechanicId;
      const requestId = String(req.params.id);

      if (!mechanicId) return res.status(403).json({ success: false, message: "Only verified mechanics can accept jobs." });
      ...
      SocketService.notifyBookingStatusUpdate(requestId, {
        status: "ACCEPTED",
  ...
  public static async addExtraCharge(req: AuthRequest, res: Response) {
    try {
      const requestId = String(req.params.id);
  ...
  public static async respondExtraCharge(req: AuthRequest, res: Response) {
    try {
      ...
      SocketService.notifyBookingStatusUpdate(charge.serviceRequestId, {
  ...
  public static async cancelBooking(req: AuthRequest, res: Response) {
    try {
      const requestId = String(req.params.id);
  ...
  public static async processPayment(req: AuthRequest, res: Response) {
    try {
      const requestId = String(req.params.id);
  ...
  public static async submitRating(req: AuthRequest, res: Response) {
    try {
      const requestId = String(req.params.id);
